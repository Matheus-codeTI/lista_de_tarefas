...
?>
<form action="include/atarefa.php?idtarefa=<?= $rowAtualizaTarefa[1] ?>" method="POST">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="input-group mb-3">
                    ...
                    <input autocomplete="off" value="<?= $rowAtualizaTarefa[2] ?>" required="" type="text" class="form-control" name="usuario">
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input required="" type="time" value="<?= $rowAtualizaTarefa[5] ?>" required="" name="horainicio" class="form-control">
            </div>
            <div class="col-md-6">
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-success">Atualizar <i class='bx bx-save'></i></button>
    </div>
</form>
<script>
    ...
    function verificaTarefa() {
        Swal.fire(
                ...
                'Click no botão para prosseguir com a ação!',
                'success'
                )
    }
</script>
